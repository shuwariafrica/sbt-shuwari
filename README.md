...
```scala
addSbtPlugin("africa.shuwari.sbt" % "sbt-shuwari-core" % "0.14.3")
```
...
```scala
addSbtPlugin("africa.shuwari.sbt" % "sbt-shuwari-header" % "0.14.3")
```
...
```scala
addSbtPlugin("africa.shuwari.sbt" % "sbt-shuwari-mode" % "0.14.3")
```
...
```scala
addSbtPlugin("africa.shuwari.sbt" % "sbt-shuwari-scalac" % "0.14.3")
```
